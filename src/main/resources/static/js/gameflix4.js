...
const container = document.getElementById('gamesContainer4');
const games = container.getElementsByClassName('modalLink4');
let isMoving = false;
...
// 캐러셀 버튼용 이벤트 리스너 추가
const leftButton = document.getElementById('carouselLeft4');
const rightButton = document.getElementById('carouselRight4');
