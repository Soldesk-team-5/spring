...
const container = document.getElementById('gamesContainer5');
const games = container.getElementsByClassName('modalLink5');
let isMoving = false;
...
// 캐러셀 버튼용 이벤트 리스너 추가
const leftButton = document.getElementById('carouselLeft5');
const rightButton = document.getElementById('carouselRight5');
