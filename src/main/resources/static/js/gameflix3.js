...
const container = document.getElementById('gamesContainer3');
const games = container.getElementsByClassName('modalLink3');
let isMoving = false;
...
// 캐러셀 버튼용 이벤트 리스너 추가
const leftButton = document.getElementById('carouselLeft3');
const rightButton = document.getElementById('carouselRight3');
